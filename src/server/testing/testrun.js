...
unitTester.register('Demo test', tests.testShouldPass);
unitTester.register('Demo test', tests.testShouldFail);
unitTester.register('Get main page', tests.testGetIndexPage);
unitTester.register('Get game page', tests.testGetGamePage);
unitTester.register('Get nearby features', tests.testNearbyFeatures);
unitTester.register('Get config', tests.testConfig);
